...
public class DynatraceManagedConfiguration extends AbstractConfiguration {
	...
	public DynatraceManagedConfiguration(String tenantId, String applicationName, String applicationID, long deviceID, String endpointURL, SSLTrustManager sslTrustManager, SessionIDProvider sessionIDProvider) {
