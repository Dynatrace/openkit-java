...
public class WebRequestTimingTest extends AbstractLocalAppMonTest {
    ...
    public void test() {
        ...
        String expectedBeacon = "vv=3&va=7.0.0000&ap=" + TEST_APPLICATION_NAME + "&an=" + TEST_APPLICATION_NAME + "&vn=" + TEST_OPENKIT_DEFAULT_VERSION + "&pt=1&tt=okjava&vi=" + testConfiguration
            .getDeviceID() + "&sn=1&ip=" + TEST_IP + "&os=" + TEST_OS + "&mf=" + TEST_MANUFACTURER + "&md=" + TEST_DEVICE_TYPE + "&tv=1004000&ts=1004000&tx=1010000&et=30&na=http%3A%2F%2Fwww.google.com%2Fapi%2Fsearch&it=1&pa=1&s0=2&t0=2000&s1=3&t1=1000&et=19&it=1&pa=0&s0=5&t0=5000&et=1&na=WebRequestTiming&it=1&ca=1&pa=0&s0=1&t0=1000&s1=4&t1=3000";
