...
public class ParallelActionTest extends AbstractLocalAppMonTest {
    ...
    public void test() {
        ...
        String expectedBeacon = "vv=3&va=7.0.0000&ap=" + TEST_APPLICATION_NAME + "&an=" + TEST_APPLICATION_NAME + "&vn=" + TEST_OPENKIT_DEFAULT_VERSION + "&pt=1&tt=okjava&vi=" + testConfiguration
            .getDeviceID() + "&sn=1&ip=" + TEST_IP + "&os=" + TEST_OS + "&mf=" + TEST_MANUFACTURER + "&md=" + TEST_DEVICE_TYPE + "&tv=1005000&ts=1004000&tx=1015000&et=19&it=1&pa=0&s0=9&t0=10000&et=1&na=ParallelAction-1&it=1&ca=2&pa=1&s0=2&t0=3000&s1=5&t1=3000&et=1&na=ParallelAction-2&it=1&ca=3&pa=1&s0=3&t0=4000&s1=6&t1=3000&et=1&na=ParallelAction-3&it=1&ca=4&pa=1&s0=4&t0=5000&s1=7&t1=3000&et=1&na=RootAction&it=1&ca=1&pa=0&s0=1&t0=2000&s1=8&t1=7000";
