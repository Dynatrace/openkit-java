...
public class ChangeSendIntervalTest extends AbstractLocalAppMonTest {
    ...
    public void test() {
        ...
        String expectedBeacon1 = "vv=3&va=7.0.0000&ap=" + TEST_APPLICATION_NAME + "&an=" + TEST_APPLICATION_NAME + "&pt=1&vi=" + testConfiguration
        ...
        String expectedBeacon2 = "vv=3&va=7.0.0000&ap=" + TEST_APPLICATION_NAME + "&an=" + TEST_APPLICATION_NAME + "&pt=1&vi=" + testConfiguration
