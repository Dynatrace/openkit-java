...
public class BeaconSendingTimeSyncStateTest {
    ...
    public void clusterTimeOffsetCanBeNegativeAsWell() {
        ...
        // given
        when(httpClient.sendTimeSyncRequest()).thenReturn(new TimeSyncResponse(mockLogger, TimeSyncResponse.RESPONSE_KEY_REQUEST_RECEIVE_TIME + "=3&" + TimeSyncResponse.RESPONSE_KEY_RESPONSE_SEND_TIME + "=6", 200, Collections.<String, List<String>>emptyMap()))
                                              .thenReturn(new TimeSyncResponse(mockLogger, TimeSyncResponse.RESPONSE_KEY_REQUEST_RECEIVE_TIME + "=12&" + TimeSyncResponse.RESPONSE_KEY_RESPONSE_SEND_TIME + "=19", 200, Collections.<String, List<String>>emptyMap()))
                                              .thenReturn(new TimeSyncResponse(mockLogger, TimeSyncResponse.RESPONSE_KEY_REQUEST_RECEIVE_TIME + "=34&" + TimeSyncResponse.RESPONSE_KEY_RESPONSE_SEND_TIME + "=36", 200, Collections.<String, List<String>>emptyMap()))
                                              .thenReturn(new TimeSyncResponse(mockLogger, TimeSyncResponse.RESPONSE_KEY_REQUEST_RECEIVE_TIME + "=45&" + TimeSyncResponse.RESPONSE_KEY_RESPONSE_SEND_TIME + "=47", 200, Collections.<String, List<String>>emptyMap()))
                                              .thenReturn(new TimeSyncResponse(mockLogger, TimeSyncResponse.RESPONSE_KEY_REQUEST_RECEIVE_TIME + "=56&" + TimeSyncResponse.RESPONSE_KEY_RESPONSE_SEND_TIME + "=58", 200, Collections.<String, List<String>>emptyMap()));
